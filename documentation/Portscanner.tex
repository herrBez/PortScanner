...
\begin{document}
	...
	returned value of the system call is used to determaine if the port to check is either closed or open at the target machine~\cite{nmap2009}.\todo{Extended description with details. Add advantages and disadvantages (table?)} 
